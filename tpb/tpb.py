...
class List(object):
    ...
    def items(self):
        ...
        on page.
        """
        request = get(str(self.url), headers={'User-Agent' : "lovely","origin_req_host" : "thepiratebay.se"})
...
class Torrent(object):
    ...
    def files(self):
        if not self._files:
            ...
            request = get(str(url), headers={'User-Agent' : "lovely","origin_req_host" : "thepiratebay.se"})
            root = html.fromstring(request.text)
